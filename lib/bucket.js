 ...
 * @public
 *
 * @param {object} s3config - s3options (http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/S3.html#constructor-property)
 * @param {string} name - site options.
 */
var Bucket = function (options, s3options) {
...
Bucket.prototype.uploadFile = function (filePath, callback) {
  ...
  fs.readFile(filePath, _.bind(function (err, fileBuffer) {
    this.s3.putObject(this._params({
      Key: fileKey,
      Body: fileBuffer,
